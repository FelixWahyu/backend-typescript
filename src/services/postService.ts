...
/**
 * Field yang dipilih untuk response post (termasuk relasi author).
 */
const selectPost = {
  id: true,
  title: true,
...
/**
 * Ambil semua post dengan pagination & search.
 */
...
/**
 * Buat post baru. Validasi author & cegah duplikasi title.
 */
